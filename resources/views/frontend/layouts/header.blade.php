                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="short_contact_list">
                            <ul>
                                <li>
                                    <a href="#"> <i class="fa fa-envelope"></i> <span class="__cf_email__" data-cfemail="1970777f76597d767a747c7d377a7674">[email&#160;protected]</span></a>
                                </li>
                                <li>
                    ...
                    <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                        <div class="Appointment">
                            <div class="book_btn d-none d-lg-block">
                                <a href="{{ route('appointment.add') }}">Make an Appointment</a>
                            </div>
                            <!-- <div class="book_btn d-none d-lg-block">
