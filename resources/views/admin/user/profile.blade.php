    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-9">
                            <form id="formPhoto" action="{{ route('user.update.photo', $user->id) }}" method="post"
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" href="#settings" data-toggle="tab">UPDATE USER
                                PROFILE</a></li>
                    </ul>
                </div><!-- /.card-header -->
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link btn btn-danger active" href="#settings"
                                data-toggle="tab">UPDATE USER PASSWORD</a></li>
                    </ul>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <!-- /.tab-pane -->
                        <div class="tab-pane active" id="settings">
                            <form class="form-horizontal" action="{{ route('user.update.password', $user->id) }}"
                                method="post">
                                @csrf
                                @method('PATCH')
