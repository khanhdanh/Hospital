    ...
    @section('content')
        <div class="container">
            ...
            <div class="section-top-border">
                <div class="row">
                    <h4 class="offset-lg-1 col-md-10 mb-4">TO REQUEST FOR AN ONLINE APPOINTMENT, PLEASE COMPLETE THE FORM
                        BELOW AND CLICK THE “REQUEST” BUTTON.</h4>
                    @if (session('message'))
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text" class="form-control" id="doctor-name" placeholder="Name"
                                            name="name">
                                        @error('name')
                                            <span style="color: red;">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group col-lg-8">
                                        <label for="doctor-name">Note</label>
                            ...
                            success: function(data) {
                                ...
                                if (data) {
                                    ...
                                    $('#appointment_time').append(
                                        '<option value="">-- Available Appointment Time --</option>'
                                    );
                                    $.each(data, function(key, value) {
                                        $('#appointment_time').append('<option value="' +
                                            value.day + '">' + value.day + '</option>');
                                    });
                                } else {
                                    $('#appointment_time').empty();
                                }
